...
author: "Andree Valle Campos, Candidato a Magister en Ciencias de la Investigación Epidemiológica. Grupo de Trabajo en Investigación Epidemiológica y Evaluación de Intervenciones Sanitarias. (avallecam\\@gmail.com)"
date: '`r Sys.Date()`'
...
Sin embargo, el formato XLSform permitió la edición colaborativa via Google Sheets y redujo el tiempo para su distribución. 
